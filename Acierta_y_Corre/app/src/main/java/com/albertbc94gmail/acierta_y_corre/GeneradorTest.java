...
public class GeneradorTest {
    //Estas son las imagenes subidas a res -> drawable
    ...
    public static Test generarTest(Context context){
        Test t = new Test();
        //Aqui crea las 14 preguntas con sus respuestas e imagenes. esto es provisional hasta q tengamos base de datos
        for(int i=1; i<=14; i++) {
        ...
        //Esto lo ha puesto para que coja la primera respuesta como la correcta, pero no ha dado tiempo a probarlo con el jordi y da error por eso lo dejo comentado. El constructor que hay en question tb es referente a esto
